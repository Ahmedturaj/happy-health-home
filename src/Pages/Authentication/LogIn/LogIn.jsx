  ...
  return (
    <div className="p-5">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-4xl">
        <div
          className="hidden bg-cover lg:block lg:w-11/12"
          style={{
            backgroundImage:
              "url('https://i.ibb.co/56vHcbz/Shiny-Happy-Doctor-Prescription-1.png')",
          }}
        ></div>
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <div className="flex justify-center mx-auto">
            <img
              ...
              src="https://i.ibb.co/mtbp7Bs/istockphoto-471629610-612x612-removebg-preview.png"
              alt=""
            />
          </div>
